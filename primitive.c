...
Funcpointer primitive_func[]  = {p_exit, p_set_prec,p_get_prec,
                                 ...
                                 p_lpi, p_llog2, p_fgamma, p_flgamma,p_ogamma, p_olgamma, p_sum, p_vsum, p_irange, p_vswap, p_sort, p_cmp,p_lis_prime, p_lnext_prime,
...
char*primitive_function_name[]={"exit", "set_prec","get_prec",
                                ...
                                "lpi", "llog2","fgamma", "flgamma", "gamma", "lgamma", "sum", "vsum", "irange", "vswap","qsort", "cmp", "lis_prime", "lnext_prime", 
